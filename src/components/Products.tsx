...
const Products: React.FC = () => {
  ...
  const products = [
    {
      ...
      features: ['55+ tonnes/year', 'Organic certified', 'Multiple varieties', 'Modern farming'],
      highlight: true,
      category: 'vegetables',
    ...
    },
    {
      ...
      features: ['Multiple varieties', '100% organic', 'Summer harvest', 'Premium quality'],
      category: 'fruits',
    ...
    },
    {
      ...
      category: 'seeds',
      price: 'Contact for bulk rates',
      availability: 'Available'
    },
    {
      name: 'Organic Brinjal',
      description: 'Fresh, organic brinjal grown with sustainable farming practices. Perfect for cooking and rich in nutrients with no chemical residues.',
      image: '/images/brinjal.jpg',
      features: ['100% organic', 'Fresh daily harvest', 'Rich in nutrients', 'Chemical-free'],
      category: 'vegetables',
      price: '₹40-60/kg',
      availability: 'Available'
    },
  ...
  const getIcon = (feature: string) => {
    if (feature.includes('organic') || feature.includes('Organic')) return <Leaf className="w-4 h-4 text-green-600" />;
    if (feature.includes('tonnes') || feature.includes('protein') || feature.includes('Iron')) return <Award className="w-4 h-4 text-orange-600" />;
    if (feature.includes('resistant') || feature.includes('Chemical-free')) return <Shield className="w-4 h-4 text-blue-600" />;
    if (feature.includes('Modern') || feature.includes('varieties')) return <Sprout className="w-4 h-4 text-purple-600" />;
          ...
          {filteredProducts.map((product, index) => (
            <div
              ...
              className={`group bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-2 ${
                product.highlight ? 'ring-2 ring-green-500 relative' : ''
              }`}
            >
              {product.highlight && (
